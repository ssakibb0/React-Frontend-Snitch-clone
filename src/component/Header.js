...
//                   <img src="img/back555.webp" alt="bg2" className="header-image" />
//                   <img src="img/backsmall5.webp" alt="bg2" className="showsmall header-image" />
//                   <video autoPlay muted loop className="header-video">
//                     <source src="./back video/video1.mp4" type="video/mp4" />
//                   </video>
//                 </div>
//               </SwiperSlide>
//               <SwiperSlide>
//                 <div className="header-slide-content">
//                   <img src="img/bg2.webp" alt="bg2" className="header-image" />
//                   <img src="img/product/new-inss.webp" alt="bg2" className="showsmall header-image" />
//                   <video autoPlay muted loop className="header-video">
//                     <source src="back video/video2.mp4" type="video/mp4" />
//                   </video>
//                 </div>
//               </SwiperSlide>
//               <SwiperSlide>
//                 <div className="header-slide-content">
//                   <img src="img/bg3.webp" alt="bg3" className="header-image" />
//                   <img src="img/product/pro2.webp" alt="bg2" className="showsmall header-image" />
//                   <video autoPlay muted loop className="header-video">
//                     <source src="back video/video3.mp4" type="video/mp4" />
//                   </video>
//                 </div>
//               </SwiperSlide>
//               <SwiperSlide>
//                 <div className="header-slide-content">
//                   <img src="img/serchCamera/produc/img1.webp" alt="bg3" className="header-image" />
//                   {/* <img src="img/product/pro2.webp" alt="bg2" className="showsmall header-image" /> */}
